...
class _BrowserSession:
    ...
    def __init__(self, browser_name: str):
        ...
        # When the real profile is locked (Chrome already running),
        # _also_open_in_real is True: go_to / search will ALSO call
        # webbrowser.open() so the URL appears in the user's real Chrome.
        # Playwright operations still run in the dedicated JARVIS profile
        # window (full click / type / scroll support).
        self._also_open_in_real: bool = False
        self._launched:          bool = False   # guard against re-launching
